...
import application.repository.JobHistoryRepository;
import org.quartz.*;
...
import static application.config.QuartzConfiguration.CONTEXT_KEY;
...
public class JobHistoryListener implements SchedulerPlugin, JobListener {
    ...
    private static final Logger log = LoggerFactory.getLogger(JobHistoryListener.class);
    private String name;
